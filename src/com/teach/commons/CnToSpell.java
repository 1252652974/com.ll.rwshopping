...
public class CnToSpell {  
    ...
    private static CnToSpell chineseSpelling = new CnToSpell();  
     ...
     * @return 
     */  
    public static String trans2PinYin(String chs) {
    	...
    	for (int i = 0; i < chs.length(); i++) {  
            ...
            if (key.getBytes().length > 1) {  
                value = (String) chineseSpelling.convert(key);  
                if (value == null) {  
                    value = key;  
                }else {
     ...
     * @return
     */
    public static String trans2JianPin(String chs) {
    	StringBuilder ret = new StringBuilder();
    	String key,value;
    	for (int i = 0; i < chs.length(); i++) {  
            key = chs.substring(i, i + 1);  
